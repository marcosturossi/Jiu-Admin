...
export interface GenerateFinancialTransactionsResultDTO { 
    year: ApiFrequencyGetPageParameter;
    month: ApiFrequencyGetPageParameter;
    feesCreated: ApiFrequencyGetPageParameter;
}
