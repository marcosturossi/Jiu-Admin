...
// @ts-ignore
import { PaginatedResultOfShowLessonDTO } from '../model/paginatedResultOfShowLessonDTO';
// @ts-ignore
...
export class LessonService implements LessonServiceInterface {
    ...
    public apiLessonGet(title?: string, page?: ApiFrequencyGetPageParameter, pageSize?: ApiFrequencyGetPageParameter, orderBy?: string, orderByDescending?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        return this.httpClient.request<PaginatedResultOfShowLessonDTO>('get', `${this.configuration.basePath}${localVarPath}`,
            {
    ...
    public apiLessonIdPut(id: string, updateLessonDTO: UpdateLessonDTO, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        if (updateLessonDTO === null || updateLessonDTO === undefined) {
            throw new Error('Required parameter updateLessonDTO was null or undefined when calling apiLessonIdPut.');
        }
    ...
    public apiLessonPost(createLessonDTO: CreateLessonDTO, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (createLessonDTO === null || createLessonDTO === undefined) {
            throw new Error('Required parameter createLessonDTO was null or undefined when calling apiLessonPost.');
        }
