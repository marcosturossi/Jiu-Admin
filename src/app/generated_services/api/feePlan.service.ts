...
// @ts-ignore
import { PaginatedResultOfShowFeePlanDTO } from '../model/paginatedResultOfShowFeePlanDTO';
// @ts-ignore
...
export class FeePlanService implements FeePlanServiceInterface {
    ...
    public apiFeePlanGet(name?: string, monthDurationMin?: ApiFrequencyGetPageParameter, monthDurationMax?: ApiFrequencyGetPageParameter, priceMin?: ApiAccountsPayableGetAmountMinParameter, priceMax?: ApiAccountsPayableGetAmountMinParameter, page?: ApiFrequencyGetPageParameter, pageSize?: ApiFrequencyGetPageParameter, orderBy?: string, orderByDescending?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        return this.httpClient.request<PaginatedResultOfShowFeePlanDTO>('get', `${this.configuration.basePath}${localVarPath}`,
            {
    ...
    public apiFeePlanIdPut(id: string, updateFeePlanDTO: UpdateFeePlanDTO, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        if (updateFeePlanDTO === null || updateFeePlanDTO === undefined) {
            throw new Error('Required parameter updateFeePlanDTO was null or undefined when calling apiFeePlanIdPut.');
        }
    ...
    public apiFeePlanPost(createFeePlanDTO: CreateFeePlanDTO, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (createFeePlanDTO === null || createFeePlanDTO === undefined) {
            throw new Error('Required parameter createFeePlanDTO was null or undefined when calling apiFeePlanPost.');
        }
