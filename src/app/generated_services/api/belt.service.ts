...
// @ts-ignore
import { PaginatedResultOfShowBeltDTO } from '../model/paginatedResultOfShowBeltDTO';
// @ts-ignore
...
export class BeltService implements BeltServiceInterface {
    ...
    public apiBeltGet(color?: string, orderIndexMin?: ApiFrequencyGetPageParameter, orderIndexMax?: ApiFrequencyGetPageParameter, isForKids?: boolean, page?: ApiFrequencyGetPageParameter, pageSize?: ApiFrequencyGetPageParameter, orderBy?: string, orderByDescending?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        return this.httpClient.request<PaginatedResultOfShowBeltDTO>('get', `${this.configuration.basePath}${localVarPath}`,
            {
    ...
    public apiBeltIdPut(id: string, updateBeltDTO: UpdateBeltDTO, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        if (updateBeltDTO === null || updateBeltDTO === undefined) {
            throw new Error('Required parameter updateBeltDTO was null or undefined when calling apiBeltIdPut.');
        }
    ...
    public apiBeltPost(createBeltDTO: CreateBeltDTO, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (createBeltDTO === null || createBeltDTO === undefined) {
            throw new Error('Required parameter createBeltDTO was null or undefined when calling apiBeltPost.');
        }
