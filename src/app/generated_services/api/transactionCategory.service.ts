...
// @ts-ignore
import { PaginatedResultOfShowTransactionCategoryDTO } from '../model/paginatedResultOfShowTransactionCategoryDTO';
// @ts-ignore
...
export class TransactionCategoryService implements TransactionCategoryServiceInterface {
    ...
    public apiTransactionCategoryGet(name?: string, isActive?: boolean, page?: ApiFrequencyGetPageParameter, pageSize?: ApiFrequencyGetPageParameter, orderBy?: string, orderByDescending?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        return this.httpClient.request<PaginatedResultOfShowTransactionCategoryDTO>('get', `${this.configuration.basePath}${localVarPath}`,
            {
    ...
    public apiTransactionCategoryIdPut(id: string, updateTransactionCategoryDTO: UpdateTransactionCategoryDTO, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        if (updateTransactionCategoryDTO === null || updateTransactionCategoryDTO === undefined) {
            throw new Error('Required parameter updateTransactionCategoryDTO was null or undefined when calling apiTransactionCategoryIdPut.');
        }
    ...
    public apiTransactionCategoryPost(createTransactionCategoryDTO: CreateTransactionCategoryDTO, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (createTransactionCategoryDTO === null || createTransactionCategoryDTO === undefined) {
            throw new Error('Required parameter createTransactionCategoryDTO was null or undefined when calling apiTransactionCategoryPost.');
        }
