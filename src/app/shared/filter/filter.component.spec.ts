...
describe('FilterComponent', () => {
  ...
  it('should clear all filters when the reset button is clicked', fakeAsync(() => {
    ...
    fixture.nativeElement.querySelector('.modal-body button').click();
    fixture.detectChanges();
    fixture.nativeElement.querySelector('.condition-row__value').value = 'active';
    fixture.nativeElement.querySelector('.condition-row__value').dispatchEvent(new Event('change'));
    fixture.detectChanges();
    fixture.nativeElement.querySelector('.modal-footer .btn-primary').click();
    fixture.detectChanges();

    fixture.nativeElement.querySelector('.filter-bar__reset').click();
    fixture.detectChanges();
